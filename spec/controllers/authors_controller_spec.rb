...
RSpec.describe AuthorsController, type: :controller do
  ...
  let(:valid_attributes) {
    { full_name: "Author name", email: "random@exmail.com"}
  }
  ...
  describe "GET #index", admin_sign_in: true do
  ...
  describe "POST #create", admin_sign_in: true do
  ...
  describe "PUT #update", admin_sign_in: true do
    context "with valid params" do
      let(:new_attributes) {
        { full_name: "Author name", email: "random@exmail.com"}
      }
      ...
      it "updates the requested author" do
        ...
        author.reload
        expect(author.full_name).to eq("Author name")
      end
  ...
  describe "new" do
    ...
    it "should not allow render of new for guest users" do
      get :new
