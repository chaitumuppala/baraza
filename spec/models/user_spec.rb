...
describe User do
  describe "validation" do
    ...
    it "should return error message if email is not unique" do
      ...
      expect(invalid_user.errors.full_messages).to eq(["Email has already been registered. To retrieve your password for this account, click on <a href='/users/password/new'> forgot your password </a> or <a href='/users/sign_in'> login here </a> "])
    end
  end
